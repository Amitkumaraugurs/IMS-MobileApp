...
class DashboardState extends State<Dashboard>{
  TextStyle style = TextStyle(fontFamily: 'Montserrat', fontSize: 14.0,color: Colors.white);
  @override
                   ...
                   Container(
                     ...
                     child: Column(
                       ...
                       children: <Widget>[
                         GestureDetector(
                             onTap: () {
                               Navigator.push(context, MaterialPageRoute(builder: (context) => IssuetoStore()));
                               print("onTap Goods.");},
                             child: Image(
                               height: 55,
                               fit:BoxFit.fill,
                   ...
                   Container(
                     ...
                     child: Column(
                       ...
                       children: <Widget>[
                         GestureDetector(
                             onTap: () {
                               Navigator.push(context, MaterialPageRoute(builder: (context) => InventoryConfirmation()));
                               print("onTap Goods.");
                               },
                             child: Image(
                               height: 55,
                 ...
                 children: <Widget>[
                   Container(
                     ...
                     child: Column(
                       ...
                       children: <Widget>[
                         GestureDetector(
                             onTap: () { Navigator.push(context, MaterialPageRoute(builder: (context) => InventoryRequest()));
                             print("onTap Goods.");},
                             child: Image(
                               height: 50,
                               fit:BoxFit.fill,
                         ...
                         Text("Inventory Request",style: style,textAlign: TextAlign.center
                         )
                       ],
                     ),
